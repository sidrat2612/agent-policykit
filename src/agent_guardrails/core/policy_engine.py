...
from agent_guardrails.core.merger import merge_packs
from agent_guardrails.core.models import PolicyBundle, ProjectContext, RulePack
...
def list_available_packs() -> dict[str, list[str]]:
    ...
    from agent_guardrails.core.loader import PACKS_DIR
